...
Grundsätzlich befasst sich die Arbeit mit Flächen im urbanen Raum. Berge, Strände und Felder werden bewusst ausgeklammert, um nicht den Rahmen der Arbeit zu sprengen. Voraussetzung ist, dass das QGIS-Plugin in Python implementiert ist und die \ac{API} von search.ch verwendet wird.
