...
Das Kapitel \ref{solution:Routing über offene Flächen} hat zwei Algorithmen hervorgebracht, namentlich \nameref{solution:Visibility-Graph} und \nameref{solution:SpiderWeb-Graph}, welche im Folgenden bewertet werden. Dazu werden messbare Kriterien definiert, gewichtet und die beiden Varianten daran gemessen. Am Ende wird den Varianten eine Punktzahl auf einer linearen Skala von 1 bis 5 zugewiesen und ein Fazit.
...
Der massgebende Maximalwert \emph{2 Stunden} ist in der nicht-funktionalen Anforderung \ref{NFA:NFA04} im Teil \ref{chap:SW-Projektdokumentation} definiert. Die Verarbeitungszeit wird bewertet auf einer Skala von 1 (2 Stunden) bis 5 (0 Minuten).
