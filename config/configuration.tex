...
%Package for syntax highlighting (needs pygments installed)
\usepackage{minted}

% Default options for python code
% usage: \begin{pycode}
% to define additional options, use \begin{pycode*}{key=value}
\newminted{py}{linenos, frame=leftline, numbersep=8pt, framesep=8pt, tabsize=4}
