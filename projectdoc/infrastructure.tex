...
Das \nameref{impl:Plaza Routing} stellt das Backend dar und bietet eine API an, die vom QGIS-Plugin benutzt wird. Neben den Online-Diensten braucht es dazu eine lokale Instanz der Routing-Engine, in unserem Fall Graphhopper \cite{graphhopper}.
