...
Verwendet werden die eingebauten Exceptions \emph{ValueError} und \emph{RuntimeError}.

\paragraph{ValueError}\label{ehp:PV:ValueError}~\\
TODO

\paragraph{RuntimeError}\label{ehp:PV:RuntimeError}~\\
TODO
...
Beide Komponente führen ein Log-File, welches zur Information oder im Fehlerfall zur Hand gezogen werden kann. Für das Logging wird die Python-Library \emph{logging} verwendet. Dadurch sind die Standard-Log-Level (default, info, warning, error) verfügbar.
