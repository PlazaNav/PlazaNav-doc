...
Der User wird zu Fuss zu einer ÖV-Haltestelle geroutet, welche sich in einem Umkreis von 2km befindet. Falls mehrere ÖV-Haltestellen verfügbar sind, wird die ÖV-Haltestelle gewählt, welche die kürzeste Reisezeit (Fussweg + ÖV-Weg) hat.
...
Die zusätzlichen Daten für die Optimierung (zusätzlich eingezeichnete Wege über öffentliche Plätze) dürfen nicht mehr als 1\% des Kartenmaterials betragen.
