...
PlazaRoute ist während dem Integrieren der neuesten \ac{OSM}-Daten in die Routing-Engine max. 2 Stunden nicht verfügbar. Der User wird nicht über den Unterbruch informiert.
