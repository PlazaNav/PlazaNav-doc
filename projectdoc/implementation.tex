...
Neben der Route wird dem Benutzer auch eine einfache Navigation (siehe Abbildung \ref{fig:qgis_plugin_plaza_route_navigation}) angezeigt, welche aus der erhaltenen Response generiert wird.  
