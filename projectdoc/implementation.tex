...
Die Kommunikation mit dem \ac{REST}-Service, welcher im Abschnitt \nameref{impl:Plaza Routing api} beschrieben ist, erfolgt über den \emph{QNetworkAccessManager}, damit auch Proxy-Einstellungen des Users im QGIS berücksichtigt werden.
